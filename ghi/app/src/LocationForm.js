    ...
    <>
        ...
        <div className="offset-3 col-6">
            ...
            <form onSubmit={handleSubmit} id="create-location-form">
                ...
                <div className="form-floating mb-3">
                <input onChange={handleRoomCountChange} value={roomCount} placeholder="Room count" required type="number" name="room_count" id="room_count" className="form-control"></input>
